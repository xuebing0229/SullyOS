...
export const Icons: Record<string, React.FC<{ className?: string }>> = {
  ...
  VoiceLibrary: ({ className }) => <Waveform className={className} weight="regular" />,
  ...
  GameHall: ({ className }) => <GameController className={className} weight="fill" />,
  ...
  Eat: ({ className }) => <BowlFood className={className} weight="regular" />,
};
...
export const INSTALLED_APPS: AppConfig[] = [
  ...
  { id: 'eat' as AppID, name: '吃了吗', icon: 'Eat', color: 'emerald' },
  ...
  { id: AppID.VoiceLibrary, name: '语音库', icon: 'VoiceLibrary', color: 'amber' },
