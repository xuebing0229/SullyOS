...
vi.mock('./chatPrompts',()=>({ChatPrompts:{buildSystemPromptParts:vi.fn(async()=>({stablePrompt:'stable',volatileState:'volatile',recencyTail:'RECENCY'})),buildMessageHistory:vi.fn(()=>({apiMessages:[]}))}}));
