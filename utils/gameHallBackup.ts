 ...
 * 游戏厅持久数据的唯一备份登记表。
 *
 * 导出、纯文字分片和导入都必须引用这里，避免新建 object store 后只补到一侧。
...
export const GAME_HALL_BACKUP_STORES = [
  ...
  { storeName: 'gameHallMessages', field: 'gameHallMessages', label: '游戏厅消息' },
  { storeName: 'gameHallPendingActions', field: 'gameHallPendingActions', label: '游戏厅待确认行动' },
  { storeName: 'gameHallBridgeSnapshots', field: 'gameHallBridgeSnapshots', label: '游戏厅聊天桥接快照' },
  { storeName: 'gameHallEvents', field: 'gameHallEvents', label: '游戏厅事件' },
  { storeName: 'gameHallMemoryCandidates', field: 'gameHallMemoryCandidates', label: '游戏厅记忆候选' },
  { storeName: 'gameHallPreferenceEvidence', field: 'gameHallPreferenceEvidence', label: '游戏厅偏好证据' },
] as const;
