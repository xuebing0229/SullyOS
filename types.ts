...
export interface InstantPushPendingToolCall {
  ...
  /** Worker 已识别出的副作用，客户端在工具执行前按原顺序重放。 */
...
export interface UserProfile {
    ...
    avatar: string;
    bio: string;
    /** 全局『我的声线』：复用 CharacterProfile.voiceProfile，仅保存声线参数，不保存 API Key。 */
    voiceProfile?: CharacterProfile['voiceProfile'];
...
export interface FullBackupData {
    ...
    gameHallProtocolCache?: Record<string, unknown>[];
    ...
    mediaAssets?: {
        ...
        novelAiReference?: CharacterProfile['novelAiReference'];
    }[];
...
// Fork-only public types (API cost ledger, simulator/reading apps, NovelAI
