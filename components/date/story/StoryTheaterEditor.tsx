        ...
        <main className='story-page-scroll flex-1 overflow-y-auto px-5 py-6 pb-28'><div className='max-w-2xl mx-auto space-y-8'>
            ...
            <section className='pt-6 border-t border-slate-200'>
                ...
                {draft.writesToCharacterMemory ? <div className='mt-5 p-4 rounded-2xl bg-amber-50 border border-amber-200'>
                    ...
                    <div className='py-3 border-y border-slate-200 flex items-center justify-between gap-4'><div><div className='text-sm font-semibold'>自动记忆输出</div><p className='mt-1 text-[10px] leading-5 text-slate-500'>虚构剧情不会自动冒充真实经历写入角色记忆；演完后可在剧场里整理“我们一起演过”的候选记忆卡，只有你确认的卡片才进入主聊天。</p></div><span className='shrink-0 px-2 py-1 rounded-full bg-slate-200 text-[9px] font-bold text-slate-500'>默认隔离</span></div>
